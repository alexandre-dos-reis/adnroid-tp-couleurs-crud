            ...
            new ActivityResultCallback<ActivityResult>() {
                ...
                public void onActivityResult(ActivityResult result) {
                    if (result.getResultCode() == RESULT_OK) {
                        ...
                        couleur.setId(id);
                        DBHelper db = new DBHelper(ListeCouleurs.this);

                        if ( requete.equals("AJOUT")) {
                            adaptateur.ajouterCouleur(couleur);
                            db.createCouleur(couleur);
                        }
                        else if ( requete.equals("MODIF"))  {
                            adaptateur.changerCouleur( adaptateur.getPositionEnCours() , couleur );
                            db.updateCouleur(couleur);
                        }
                    }
